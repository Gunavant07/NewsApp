...
import com.example.newsapp.Fragment.India
import com.example.newsapp.R

class IndiaAdapter(val activity: FragmentActivity?,val  list: ArrayList<ArticlesItem>) : RecyclerView.Adapter<IndiaAdapter.ViewData>() {
